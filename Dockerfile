# -----------------------------------------------------------------------------
# Dockerfile for Rhasspy Remote HTTP Service
# (https://github.com/rhasspy/rhasspy-remote-http-hermes)
#
...
ENV APP_DIR=/usr/lib/rhasspy-remote-http-hermes
...
COPY rhasspyremote_http_hermes/ ${APP_DIR}/rhasspyremote_http_hermes

ENTRYPOINT ["bash", "/usr/lib/rhasspy-remote-http-hermes/bin/rhasspy-remote-http-hermes"]
